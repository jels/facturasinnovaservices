                    ...
                    MensajeResponse.builder()
                            ...
                            .objeto(
                                    RgfacturaDto.builder()
                                            .idRgFactura(rgfacturaSave.getIdRgFactura())
                                            .empresa(rgfacturaSave.getEmpresa())
                                            .mesPeriodo(rgfacturaSave.getMesPeriodo())
                                            .anhoPeriodo(rgfacturaSave.getAnhoPeriodo())
                                            .codigoTipoRegistro(rgfacturaSave.getCodigoTipoRegistro())
                                            .codigoTipoComprador(rgfacturaSave.getCodigoTipoComprador())
                                            .nroIdentificadorComprador(rgfacturaSave.getNroIdentificadorComprador())
                                            .nombreComprador(rgfacturaSave.getNombreComprador())
                                            .codigoTipoComprobante(rgfacturaSave.getCodigoTipoComprobante())
                                            .fechaEmision(rgfacturaSave.getFechaEmision())
                                            .nroTimbrado(rgfacturaSave.getNroTimbrado())
                                            .nroComprobante(rgfacturaSave.getNroComprobante())
                                            .montoIva10(rgfacturaSave.getMontoIva10())
                                            .montoIva5(rgfacturaSave.getMontoIva5())
                                            .montoExenta(rgfacturaSave.getMontoExenta())
                                            .montoTotalComprobante(rgfacturaSave.getMontoTotalComprobante())
                                            .condicionVenta(rgfacturaSave.getCondicionVenta())
                                            .monedaExtranjera(rgfacturaSave.getMonedaExtranjera())
                                            .imputaIva(rgfacturaSave.getImputaIva())
                                            .imputaIre(rgfacturaSave.getImputaIre())
                                            .imputaIrpRsp(rgfacturaSave.getImputaIrpRsp())
                                            .comprobanteAsociado(rgfacturaSave.getComprobanteAsociado())
                                            .timbradoComprobanteAsociado(rgfacturaSave.getTimbradoComprobanteAsociado())
                                            .createdBy(rgfacturaSave.getCreatedBy())
                                            .createdAt(rgfacturaSave.getCreatedAt())
                                            .updatedBy(rgfacturaSave.getUpdatedBy())
                                            .updatedAt(rgfacturaSave.getUpdatedBy())
                                            .build())
                            .build(),
                    HttpStatus.CREATED);
        } catch (Exception e) {
            ...
            if (rgfacturaService.existsById(id)) {
                ...
                return new ResponseEntity<>(MensajeResponse.builder()
                        ...
                        .objeto(RgfacturaDto.builder()
                                ...
                                .codigoTipoRegistro(rgfacturaUpdate.getCodigoTipoRegistro())
                                .codigoTipoComprador(rgfacturaUpdate.getCodigoTipoComprador())
                                .nroIdentificadorComprador(rgfacturaUpdate.getNroIdentificadorComprador())
                                .nombreComprador(rgfacturaUpdate.getNombreComprador())
                                .codigoTipoComprobante(rgfacturaUpdate.getCodigoTipoComprobante())
                                ...
                                .montoTotalComprobante(rgfacturaUpdate.getMontoTotalComprobante())
                                ...
                                .comprobanteAsociado(rgfacturaUpdate.getComprobanteAsociado())
                                .timbradoComprobanteAsociado(rgfacturaUpdate.getTimbradoComprobanteAsociado())
