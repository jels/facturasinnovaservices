...
public class AjusteController {
        ...
        public ResponseEntity<?> showSettingsDetail(@PathVariable Integer id) {

                Ajuste ajuste = ajusteService.findById(id);
                // AjusteDetalleDto ajusteConDetalle = new AjusteDetalleDto(id, null, null,
                // null, null, null, null);
                ...
                List<DetalleAjuste> ajusteDetalle = detalleAjusteService.getDetalleByAjuste(ajuste.getIdAjuste());

                // ajusteConDetalle.setIdAjuste(id);
                // ajusteConDetalle.setNombreAjuste(ajuste.getNombreAjuste());
                // ajusteConDetalle.setEmpresa(ajuste.getEmpresa());
                // ajusteConDetalle.setAcronimo(ajuste.getAcronimo());
                // ajusteConDetalle.setDescripcion(ajuste.getDescripcion());
                // ajusteConDetalle.setStatus(ajuste.getStatus());
                // ajusteConDetalle.setDetalles(ajusteDetalle);

                return new ResponseEntity<>(
                                MensajeResponse.builder()
                                                .mensaje("Registro encontrado:")
                                                .objeto(ajusteDetalle),
                                HttpStatus.OK);

        }

        @GetMapping("setting/details")
        public ResponseEntity<?> showDetailSettings(@PathVariable Integer id) {
